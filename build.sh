...
#Iterate servers for deploy and pull last commit
      ...
      sshpass -p $DEPLOY_PASS ssh -o StrictHostKeyChecking=no -o PreferredAuthentications=password -o PubkeyAuthentication=no $DEPLOY_USER@$DEPLOY_SERVER "cd /opt && mkdir deploy1"